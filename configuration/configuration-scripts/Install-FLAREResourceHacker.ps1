<#  
	.SYNOPSIS  
	Installs Resource Hacker from the Internet via Chocolatey (FLARE). 

	.DESCRIPTION  
	Author: Dane Stuckey (@cryps1s)
	License: MIT  

	Performs a standard chocolatey installation of the most recent stable version of Resource Hacker. (FLARE) 
...
$PackageName = "resourcehacker.flare"
