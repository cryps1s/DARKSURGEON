<#  
	.SYNOPSIS  
	Installs IISGeolocate from the Internet via Chocolatey. 

	.DESCRIPTION  
	Author: Dane Stuckey (@cryps1s)
	License: MIT  

	Performs a standard chocolatey installation of the most recent stable version of IISGeolocate. 
...
[String]$PackageName = "iisgeolocate"
[Int]$RetryCounter = 0
[Int]$RetryMax = 3 
[Int]$SleepCounter = 30
