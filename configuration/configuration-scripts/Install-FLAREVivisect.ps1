<#  
	.SYNOPSIS  
	Installs vivisect from the Internet via Chocolatey (FLARE). 

	.DESCRIPTION  
	Author: Dane Stuckey (@cryps1s)
	License: MIT  

	Performs a standard chocolatey installation of the most recent stable version of vivisect. (FLARE) 
...
$PackageName = "vivisect"
[Array] $OptionalArguments = "--skip-virus-check","https://github.com/williballenthin/vivisect/zipball/master","-source","python"
