<#  
	.SYNOPSIS  
	Installs posh-sysmon from the Internet via the Powershell Gallery. 

	.DESCRIPTION  
	Author: Dane Stuckey (@cryps1s)
	License: MIT  

	Performs a standard installation of posh-sysmon using the Powershell Gallery.
