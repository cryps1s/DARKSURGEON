<#  
	.SYNOPSIS  
	Installs PEStudio from the Internet via Chocolatey (FLARE). 

	.DESCRIPTION  
	Author: Dane Stuckey (@cryps1s)
	License: MIT  

	Performs a standard chocolatey installation of the most recent stable version of PEStudio. (FLARE) 
...
[Array] $OptionalArguments = "--skip-virus-check","--ignore-checksums"
#PEstudio gets updated so often that checksums are almost always out of date.
